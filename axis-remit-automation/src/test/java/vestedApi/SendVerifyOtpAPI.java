...
public class SendVerifyOtpAPI extends ApiBaseTest {
	 ...
	 */
	@Test(dependsOnMethods = "verifyGenerateTokenApiWithValidCRNAndAccountNumber", description = "Verify OTP is sent successfully to customer's registered mobile number")
	 ...
	 */
	@Test(dependsOnMethods = "verifySendOtpApiTriggersSmsToCustomerRegisteredMobileNumber", description = "Verify API returns error when incorrect OTP is provided")
...
//    }
	 ...
	 */
	@Test(dependsOnMethods = "verifySendOtpApiTriggersSmsToCustomerRegisteredMobileNumber", description = "Verify API returns error when OTP is less than 6 digits")
	 ...
	 */
	@Test(dependsOnMethods = "verifySendOtpApiTriggersSmsToCustomerRegisteredMobileNumber", description = "Verify API returns error when OTP is more than 6 digits")
	 ...
	 */
	@Test(dependsOnMethods = "verifySendOtpApiTriggersSmsToCustomerRegisteredMobileNumber", description = "Verify API returns error when OTP contains alphabetic characters")
	 ...
	 */
	@Test(dependsOnMethods = "verifySendOtpApiTriggersSmsToCustomerRegisteredMobileNumber", description = "Verify API returns error when authToken is missing")
	public void verifyOtpApiWithoutAuthToken() {

		Map<String, Object> requestBody = getOtpRequest();
		requestBody.put("otp", "123456");

		Response response = given().spec(requestSpec).body(requestBody).post("/services/api/partner/verifyOTP");
	 ...
	 */
	@Test(dependsOnMethods = "verifyGenerateTokenApiWithValidCRNAndAccountNumber", description = "Verify API returns error when CRN is missing in Send OTP request")
	 ...
	 */
	@Test(dependsOnMethods = "verifyGenerateTokenApiWithValidCRNAndAccountNumber", description = "Verify API returns error when authToken is invalid or expired")
	 ...
	 */
	@Test(dependsOnMethods = "verifyGenerateTokenApiWithValidCRNAndAccountNumber", description = "Verify API returns error when authToken is not provided in header")
	public void verifySendOtpApiWithoutAuthTokenInHeader() {

		Map<String, Object> requestBody = getOtpRequest();

		Response response = given().spec(requestSpec).body(requestBody).post("/services/api/partner/sendOTP");
